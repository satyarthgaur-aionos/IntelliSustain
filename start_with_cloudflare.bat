@echo off
title Inferrix AI Agent Demo - Cloudflare Tunnels
echo.
echo ========================================
echo    INFERRIX AI AGENT - CLOUDFLARE MODE
echo ========================================
echo.
echo 🔁 Launching Inferrix AI Agent with Cloudflare Tunnels...
echo.
...
echo.
echo ========================================
echo    CLOUDFLARE TUNNELS READY!
echo ========================================
echo.
echo ✅ All services started in separate terminals.
echo Wait 30-60 seconds for all services to fully load.
echo.
echo Next step: Run launch_all_tunnels.bat to start Cloudflare tunnels
echo.
pause 